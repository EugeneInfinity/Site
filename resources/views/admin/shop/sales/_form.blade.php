...
<div class="row">
    <div class="col-lg-6">
        ...
        @include('admin.fields.field-checkbox', [
            'label' => 'Выводить на фронт',
            'field_name' => 'show',
            'status' => isset($sale) ? $sale->show : false,
        ])
        ...
        <div class="form-group {{ $errors->has('url') ? 'has-error' : ''}}">
            {!! Form::label('url', 'Ссылка для перехода', ['class' => 'control-label']) !!}
            {!! Form::text('url', isset($sale) ? $sale->url : null, ['class' => 'form-control',]) !!}
