...
$factory->define(\App\Models\Shop\Product::class, function (Faker $faker) {
    ...
    $price_old = $faker->randomElement([$price + rand(0,200)*100, 0]);
...
$factory->define(App\Models\Shop\Sale::class, function (Faker $faker) {
    ...
    return [
        'name' => $faker->city,
        'publish' => 1,
        'description' => $faker->paragraph(rand(12, 15)),
        'discount_type' => $discountType,
        'discount' => $discountType == 1 ? rand(15, 80) : rand(50000, 400000),
